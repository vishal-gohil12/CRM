...
import { FiClock, FiCalendar, FiMessageSquare, FiX, FiSend, FiChevronDown, FiUser, FiUsers, FiType, FiKey, FiMail } from 'react-icons/fi';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-hidden">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[95vh] flex flex-col overflow-hidden transform transition-all animate-fadeIn">
        ...
        >
          ...
          {/* Email Key Input - New Field */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 items-center">
              <FiKey className="mr-2 text-orange-500 inline" /> Email Key *
            </label>
            <div className="relative">
              <input
                type="text"
            ...
            <p className="text-xs text-gray-500 mt-1">
              A unique identifier for tracking this email communication
            </p>
          </div>
